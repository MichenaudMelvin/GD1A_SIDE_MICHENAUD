...
Téléchargez le repository en zip, éxecutez mooongoose et entrer "http://localhost:8000/" dans votre navigateur

ou allez à l'adresse https://michenaudmelvin.github.io/GD1A_SIDE_MICHENAUD/ (recommandé)  
...
J'ai réalisé les assets avec [Adobe Photoshop](https://www.adobe.com/products/photoshop.html) et également utilisé [tiled](https://github.com/mapeditor/tiled) pour créer l'architecture du niveau
...
Download zip, execute moongoose and put "http://localhost:8000/" in your navigator
...
I made assets with [Adobe Photoshop](https://www.adobe.com/products/photoshop.html) and also used [tiled](https://github.com/mapeditor/tiled) to create the architecture of the level
